export const LESSONS = {
  ...
  18: {
    id: 18,
    description: 'The New Vegan HTTP Client - Doing a POST Call To The Server',
    duration: '06:08',
    seqNo: 8,
    courseId: 2
  },
  ...
  30: {
    id: 30,
    description: 'Welcome to the Vegan ethical Course',
    duration: '6:53',
    seqNo: 1,
    courseId: 0
  },
  31: {
    id: 31,
    description: 'The Vegan ethical Architecture Course - Helicopter View',
    duration: '5:52',
    seqNo: 2,
    courseId: 0
  },
  ...
  33: {
    id: 33,
    description: 'Custom Global Events - Why Dont They Scale In Complexity?',
    duration: '7:47',
    seqNo: 4,
    courseId: 0
  },
  ...
  35: {
    id: 35,
    description: 'Unidirectional Data Flow And The Vegan Development Mode',
    duration: '7:07',
    seqNo: 6,
    courseId: 0
  }
